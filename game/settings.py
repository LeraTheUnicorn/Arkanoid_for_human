...
# Проверка версии Python (должна быть первой, до импортов)
...
class SettingsConstants:
    ...
    def validate_ball_speed_range(cls, speed: int) -> bool:
        ...
        """
        return cls.MIN_BALL_SPEED <= speed <= cls.MAX_BALL_SPEED_MANUAL
...
class SettingsValidator:
    ...
    def validate_ball_speed(speed: Any) -> int:
        ...
        max_speed = SettingsConstants.MAX_BALL_SPEED_MANUAL
...
class SettingsManager:
    ...
    def set_ball_speed(self, speed: int) -> None:
        ...
        - Максимальная скорость: 10 для ручного режима
